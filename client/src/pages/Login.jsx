  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg p-8 animate-slide-up">
        <h1 className="text-2xl font-bold text-center text-gray-800 mb-1">欢迎回来</h1>
        <p className="text-center text-gray-400 text-sm mb-6">登录你的打卡账号</p>
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          还没有账号？
          <a href="/register" className="text-indigo-600 hover:text-indigo-700 font-medium">立即注册</a>
        </p>
      </div>
    </div>
  )
